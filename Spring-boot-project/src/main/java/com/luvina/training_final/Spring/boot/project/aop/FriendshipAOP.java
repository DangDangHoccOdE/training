...
public class FriendshipAOP {
    ...
    @Before(value = "execution(* com.luvina.training_final.Spring.boot.project.controller.FriendshipController.sendFriendRequest(..)) && args(..,senderId,receiverId)", argNames = "senderId,receiverId")
    ...
    @Before(value = "execution(* com.luvina.training_final.Spring.boot.project.controller.FriendshipController.sendFriendRequest(..)) && args(friendshipId))")
    ...
    @Before(value = "(execution(* com.luvina.training_final.Spring.boot.project.controller.FriendshipController.acceptFriend(..))" +
            " || execution(* com.luvina.training_final.Spring.boot.project.controller.FriendshipController.declineFriendship(..))"+
            "&& args(friendshipId))")
